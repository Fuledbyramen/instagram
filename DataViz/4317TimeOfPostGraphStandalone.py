...
plt.xlabel('Hour of day', fontsize=14, color='white')
plt.ylabel('Average likes', fontsize=14, color='white')
plt.title('Average likes per hour across {} posts'.format(limit), fontsize=16, color='white')
plt.savefig('cleanDaysAndHoursStandalone.png', edgecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333), facecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333))
plt.show()
