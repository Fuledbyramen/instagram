...
ax.annotate('Optimal Position', xy=(50, likes[50] * 1.1), xytext=(53, likes[50] * 1.5), color="black",
...
plt.title('Optimal Caption Length', fontsize=20, color='black')
plt.savefig('likesPercentileWeb.png', transparent=True)
plt.show()
