...
plt.title('Optimal Hashtag Amount', fontsize=20, color='white')
plt.savefig('optimalHashtagAmount12Standalone.png', edgecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333), facecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333))
plt.show()
