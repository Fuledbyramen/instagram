...
def graph(sub, bins, low, high, step):
	...
	plt.xticks(x_ticker, xvalues, fontsize=14, color="black", rotation=60)

	plt.xlabel('Follower Count', fontsize=18, color='black')
	plt.ylabel('Amount of people', fontsize=18, color='black')
	plt.title('Amount in range {} - {} Bin Seperation {}'.format(low, high, step), fontsize=20, color='black')
...
plt.savefig('FollowerHistogramStandalone.png', transparent=True)
plt.show()