...
plt.xticks(xvalues, fontsize=14, color="white")  
plt.yticks(test, tags, fontsize=16, color="white")

ax.get_xaxis().get_major_formatter().set_scientific(False)

plt.xlabel("Amount of posts", fontsize=18, color="white")
plt.ylabel("Hashtag", fontsize=18, color="white")
plt.title("Top 25 Hashtags By Popularity", fontsize=20, color="white")
plt.barh(test, posts, align='center', color=(51/255.,122/255.,183/255.), edgecolor="black", height=1)

plt.savefig('Top25HashtagsByPost.png', edgecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333), facecolor=(0.15294117647058825, 0.1568627450980392, 0.13333333333333333))
plt.show()